...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/boost/1.47.0/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/boost/1.47.0/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/boost/1.47.0/include
...
ALL_TOOLS      += bz2lib
bz2lib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/bz2lib/1.0.5/include
bz2lib_EX_LIB := bz2
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/cascade/2.2.04-cms6/include

ALL_TOOLS      += castor
castor_EX_LIB := shift castorrfio castorclient castorcommon
castor_EX_USE := castor_header uuid

ALL_TOOLS      += castor_header
castor_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/castor/2.1.13.6/include /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/castor/2.1.13.6/include/shift

ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/cgal/4.2/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/charybdis/1.003-cms6/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/classlib/3.1.3-cms3/include
...
ALL_TOOLS      += db4
db4_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/db4/4.4.20/include
db4_EX_LIB := db

ALL_TOOLS      += dbs-client

ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/dcap/2.47.5.0-cms/include
dcap_EX_LIB := dcap

ALL_TOOLS      += dpm
dpm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/dpm/1.8.0.1/include
dpm_EX_LIB := dpm
dpm_EX_LIBDIR := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/dpm/1.8.0.1/lib

ALL_TOOLS      += elementtree
elementtree_EX_USE := gccxml python

ALL_TOOLS      += evtgenlhc
evtgenlhc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/evtgenlhc/9.1
evtgenlhc_EX_LIB := evtgenlhc
evtgenlhc_EX_USE := clhep

ALL_TOOLS      += expat
expat_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/expat/2.0.1/include
expat_EX_LIB := expat

ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/fastjet/3.0.1-cms2/include
fastjet_EX_LIB := fastjetplugins fastjettools siscone siscone_spherical fastjet

ALL_TOOLS      += fftjet
fftjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/fftjet/1.3.1-cms/include
fftjet_EX_LIB := fftjet

ALL_TOOLS      += fftw3
fftw3_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/fftw3/3.2.2-cms/include
fftw3_EX_LIB := fftw3

ALL_TOOLS      += frontier_client
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/frontier_client/2.8.8/include
...
ALL_TOOLS      += gdbm
gdbm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/gdbm/1.8.3/include
gdbm_EX_LIB := gdbm
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/geant4/9.4.p03-cms/include
...
ALL_TOOLS      += gsl
gsl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/gsl/1.10/include
gsl_EX_LIB := gsl gslcblas

ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/hector/1_3_4-cms43/include
...
hepmc_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/hepmc/2.06.07-cms/include

ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/heppdt/3.03.00/include
heppdt_EX_LIB := HepPDT HepPID

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/herwig/6.521-cms4/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/herwigpp/2.7.1/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/jemalloc/2.2.2/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/jimmy/4.2-cms7/include

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/ktjet/1.06/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/lhapdf/5.9.1/include
...
ALL_TOOLS      += libhepml
libhepml_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/libhepml/0.2.1/interface
libhepml_EX_LIB := hepml

ALL_TOOLS      += libjpg
libjpg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/libjpg/8b/include
libjpg_EX_LIB := jpeg

ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/libpng/1.2.46/include
libpng_EX_LIB := png
libpng_EX_USE := zlib

ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/libtiff/3.9.4/include
libtiff_EX_LIB := tiff
libtiff_EX_USE := libjpg zlib

ALL_TOOLS      += libungif
libungif_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/libungif/4.1.4/include
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/llvm/3.2/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += mcdb
mcdb_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/mcdb/1.0.2/interface
mcdb_EX_LIB := mcdb
mcdb_EX_USE := xerces-c

ALL_TOOLS      += meschach
meschach_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/meschach/1.2.pCMS1/include
...
ALL_TOOLS      += mimetic
mimetic_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/mimetic/0.9.6/include
...
ALL_TOOLS      += openssl
openssl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/openssl/0.9.8e/include
openssl_EX_LIB := ssl crypto

ALL_TOOLS      += oracle
oracle_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/oracle/11.2.0.3.0__10.2.0.4.0/include
...
ALL_TOOLS      += pacparser
pacparser_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/pacparser/1.3.1/include
pacparser_EX_LIB := pacparser

ALL_TOOLS      += pcre
pcre_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/pcre/7.9/include
pcre_EX_LIB := pcre
...
photos_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/photos/215.5/include

ALL_TOOLS      += professor

ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/protobuf/2.4.1/include
...
pythia6_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/pythia6/426/include

ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/pythia8/200/include
...
ALL_TOOLS      += python
python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/python/2.6.4/include/python2.6
python_EX_LIB := python2.6
python_EX_USE := sockets

ALL_TOOLS      += qt
qt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/qt/4.6.3/include/QtOpenGL /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/qt/4.6.3/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/qt/4.6.3/include/Qt3Support
...
qtdesigner_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/qt/4.6.3/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := qtbase qt

ALL_TOOLS      += qtextra
qtextra_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/qt/4.6.3/include/QtScript
qtextra_EX_LIB := QtScript
qtextra_EX_USE := qtbase

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/rivet/1.9.0/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/lcg/roofit/5.32.03-cms19/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/lcg/root/5.32.00-cms24/include

ALL_TOOLS      += rootcint
rootcint_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/lcg/root/5.32.00-cms24/cint
...
rootrflx_EX_FLAGS_GENREFLEX_CPPFLAGS  := -DCMS_DICT_IMPL -D_REENTRANT -DGNUSOURCE
...
ALL_TOOLS      += self
self_EX_INCLUDE := /home/aevans/CMS/phistar/tuningAna/CMSSW_5_3_22/src /home/aevans/CMS/phistar/tuningAna/CMSSW_5_3_22/include/LCG /cvmfs/cms.cern.ch/slc5_amd64_gcc462/cms/cmssw/CMSSW_5_3_22/src /cvmfs/cms.cern.ch/slc5_amd64_gcc462/cms/cmssw/CMSSW_5_3_22/include/LCG
self_EX_LIBDIR := /home/aevans/CMS/phistar/tuningAna/CMSSW_5_3_22/lib/slc5_amd64_gcc462 /home/aevans/CMS/phistar/tuningAna/CMSSW_5_3_22/external/slc5_amd64_gcc462/lib /cvmfs/cms.cern.ch/slc5_amd64_gcc462/cms/cmssw/CMSSW_5_3_22/lib/slc5_amd64_gcc462 /cvmfs/cms.cern.ch/slc5_amd64_gcc462/cms/cmssw/CMSSW_5_3_22/external/slc5_amd64_gcc462/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/sherpa/1.4.2-cms2/include/SHERPA-MC
...
ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/sigcpp/2.2.10/include/sigc++-2.0
...
ALL_TOOLS      += sqlite
sqlite_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/sqlite/3.6.23/include
...
tauola_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/tauola/27.121.5/include

ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/tauolapp/1.1.4-cms/include
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/thepeg/1.9.2/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := lhapdf gsl

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/tkonlinesw/2.7.0-cms9/include
...
toprex_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/toprex/4.23/include

ALL_TOOLS      += uuid
uuid_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/uuid/1.38/include
uuid_EX_LIB := uuid
uuid_EX_USE := sockets

ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/valgrind/3.6.1/include

ALL_TOOLS      += x11
x11_EX_USE := sockets

ALL_TOOLS      += xdaq
xdaq_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/xdaq/VR17173/include /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/xdaq/VR17173/include/linux
...
xdaq_EX_USE := xerces-c sockets mimetic uuid
xdaq_EX_FLAGS_CPPDEFINES  := -DSOAP__ -DLITTLE_ENDIAN__ -Dlinux

ALL_TOOLS      += xdaqheader
xdaqheader_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/xdaq/VR17173/include
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/xrootd/3.2.4-cms2/include/xrootd
xrootd_EX_LIB := XrdUtils XrdClient

ALL_TOOLS      += xz
xz_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/xz/5.0.3-cms/include
xz_EX_LIB := lzma
...
ALL_TOOLS      += zlib
zlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc462/external/zlib/1.2.3/include
zlib_EX_LIB := z
