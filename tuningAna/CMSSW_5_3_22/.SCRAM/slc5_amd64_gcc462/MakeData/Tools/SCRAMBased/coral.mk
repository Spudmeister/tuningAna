...
lcg_CoralBase_EX_USE := $(foreach d, coral  boost boost_filesystem CoralBricks,$(if $($(d)_EX_FLAGS_NO_RECURSIVE_EXPORT),,$d))
...
lcg_CoralKernel_EX_USE := $(foreach d, coral  CoralBricks LCG/CoralBase,$(if $($(d)_EX_FLAGS_NO_RECURSIVE_EXPORT),,$d))
...
lcg_ConnectionService_EX_USE := $(foreach d, coral  uuid LCG/CoralCommon LCG/RelationalAccess boost,$(if $($(d)_EX_FLAGS_NO_RECURSIVE_EXPORT),,$d))
