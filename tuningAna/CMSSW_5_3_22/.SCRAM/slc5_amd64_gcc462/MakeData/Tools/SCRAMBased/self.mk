...
FWCoreUtilities_EX_USE := $(foreach d, self  boost boost_filesystem boost_regex rootcintex rootcore rootrflx uuid,$(if $($(d)_EX_FLAGS_NO_RECURSIVE_EXPORT),,$d))
...
GeneratorInterfaceCascadeInterface_LOC_USE := self  GeneratorInterface/CascadeInterface pydata GeneratorInterface/PartonShowerVeto GeneratorInterface/ExternalDecays heppdt
...
GeneratorInterfacePythia6Guns_LOC_USE := self  GeneratorInterface/Pythia6Interface pydata heppdt
...
GeneratorInterfacePythia6Filters_LOC_USE := self  GeneratorInterface/Pythia6Interface pydata GeneratorInterface/PartonShowerVeto GeneratorInterface/ExternalDecays heppdt
