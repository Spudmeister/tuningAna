...
int main() {
    ...
    TFile* mc2_tfile = new TFile(
            "/data/whybee0a/user/gude_2/MC/20150318_POWHEG_CT10/POWHEG_DRESSED_hadded.root"
            , "READ");
    DataConfig mc2_config(
            mc2_tfile,
            CUTLEVEL,
            "DY to ee",
            1966.7, // Powheg
    ...
    // Setup the plotter for MADGRAPH signal
    ...
    // Now with POWHEG signal
    CrossCheckPlotter* plotter2 = new CrossCheckPlotter(
            data_config,
            mc2_config,
            bg_map
            );
    ...
    // Make a plot
    //plotter2->plot(Z_MASS_ALL, "z_mass_all_powheg.pdf");
    //plotter2->plot(Z_MASS_COARSE, "z_mass_coarse_powheg.pdf");
    //plotter2->plot(Z_MASS_FINE, "z_mass_fine_powheg.pdf");
    //plotter2->plot(Z_RAPIDITY, "z_rapidity_powheg.pdf");
    //plotter2->plot(Z_PT, "z_pt_powheg.pdf");
    //plotter2->plot(E0_PT, "e0_pt_powheg.pdf");
    //plotter2->plot(E0_ETA, "e0_eta_powheg.pdf");
    //plotter2->plot(E0_PHI, "e0_phi_powheg.pdf");
    //plotter2->plot(E0_CHARGE, "e0_charge_powheg.pdf");
    //plotter2->plot(E1_PT, "e1_pt_powheg.pdf");
    //plotter2->plot(E1_ETA, "e1_eta_powheg.pdf");
    //plotter2->plot(E1_PHI, "e1_phi_powheg.pdf");
    //plotter2->plot(E1_CHARGE, "e1_charge_powheg.pdf");
    plotter2->plot(PHISTAR, "phistar_powheg.pdf");
    //plotter2->plot(N_VERTS, "n_verts_powheg.pdf");
    //plotter2->plot(N_E, "n_e_powheg.pdf");
    //plotter2->plot(E0_R9, "e0_r9_powheg.pdf");
    //plotter2->plot(E1_R9, "e1_r9_powheg.pdf");
    //plotter2->plot(E0_SIGMAIETA, "e0_sigmaieta_powheg.pdf");
    //plotter2->plot(E1_SIGMAIETA, "e1_sigmaieta_powheg.pdf");
    //plotter2->plot(E0_HE, "e0_HE_powheg.pdf");
    //plotter2->plot(E1_HE, "e1_HE_powheg.pdf");
    //plotter2->plot(E0_DETA, "e0_deta_powheg.pdf");
    //plotter2->plot(E1_DETA, "e1_deta_powheg.pdf");
    //plotter2->plot(E0_DPHI, "e0_dphi_powheg.pdf");
    //plotter2->plot(E1_DPHI, "e1_dphi_powheg.pdf");
    //plotter2->plot(E0_TRACKISO, "e0_track_iso_powheg.pdf");
    //plotter2->plot(E1_TRACKISO, "e1_track_iso_powheg.pdf");
    //plotter2->plot(E0_ECALISO, "e0_ecal_iso_powheg.pdf");
    //plotter2->plot(E1_ECALISO, "e1_ecal_iso_powheg.pdf");
    //plotter2->plot(E0_HCALISO, "e0_hcal_iso_powheg.pdf");
    //plotter2->plot(E1_HCALISO, "e1_hcal_iso_powheg.pdf");
    //plotter2->plot(E0_1OEM1OP, "e0_1oe_1op_iso_powheg.pdf");
    //plotter2->plot(E1_1OEM1OP, "e1_1oe_1op_iso_powheg.pdf");
