...
void read_testIOGenEvent(std::ostream & os)
{
    ...
    const char infile[] = "/home/aevans/CMS/phistar/generation/HepMC-2.06.09/test/testIOGenEvent.input";
...
void read_variousFormats(std::ostream & os)
{
    ...
    const char infile[] = "/home/aevans/CMS/phistar/generation/HepMC-2.06.09/test/testHepMCVarious.input";
    std::ifstream is( infile );
    if( !is ) {
      std::cerr << "cannot open " << infile << std::endl;
      exit(-1);
